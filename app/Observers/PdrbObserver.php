...
class PdrbObserver
{
    ...
    public function updated(Pdrb $pdrb)
    {
        ...
        if ($pdrb->status_data == 2) {
            ...
            $new_rekon->c_4a_adj = 0;
            $new_rekon->c_4b = $pdrb->c_4b;
            $new_rekon->c_4b_adj = 0;
