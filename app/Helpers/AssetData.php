...
class AssetData
{
    ...
    public static function getGroupKomponen()
    {
        return [
            ...
            [
                'column' => 'c_1, c_1a, c_1b, c_1c, c_1d, c_1e, c_1f, c_1g',
                'column_alias' => "1., 1.a., 1.b., 1.c., 1.d., 1.e., 1.f., 1.g.",
                'name' => '1. Pengeluaran Konsumsi Rumah Tangga'
            ],
            [
                'column' => 'c_2',
                'column_alias' => "2.",
                'name' => '2. Pengeluaran Konsumsi LNPRT'
            ],
            [
                'column' => 'c_3',
                'column_alias' => "3.",
                'name' => '3. Pengeluaran Konsumsi Pemerintah'
            ],
            [
                'column' => 'c_4, c_4a, c_4b',
                'column_alias' => "4., 4.a., 4.b.",
                'name' => '4. Pembentukan Modal tetap Bruto'
            ],
            [
                'column' => 'c_5',
                'column_alias' => "5.",
                'name' => '5. Perubahan Inventori'
            ],
            [
                'column' => 'c_6',
                'column_alias' => "6.",
    ...
    public static $list_group_12_pkrt = [
        [
            'column' => "c_1, c_1a, c_1b, c_1c, c_1d, c_1e, c_1f, c_1g, c_1h, c_1i, c_1j, c_1k, c_1l",
            'column_alias' => "1., 1.a., 1.b., 1.c., 1.d., 1.e., 1.f., 1.g., 1.h., 1.i., 1.j., 1.k., 1.l.",
            'name' => '1. Pengeluaran Konsumsi Rumah Tangga'
        ],
        [
            'column' => "c_2",
    ...
    public static $list_detail_komponen_12_pkrt = [
        ...
        ['id' => 'c_1h',  'alias' => '1h. PKRT-Komunikasi', 'name' => '1.h. Komunikasi'],
        ['id' => 'c_1i',  'alias' => '1i. PKRT-Rekreasi',   'name' => '1.i. Rekreasi dan Budaya'],
        ['id' => 'c_1j',  'alias' => '1j. PKRT-Pendidikan', 'name' => '1.j. Pendidikan'],
        ['id' => 'c_1k',  'alias' => '1k. PKRT-Hotel',      'name' => '1.k. Penginapan dan Hotel'],
        ['id' => 'c_1l',  'alias' => '1l. PKRT-Jasa',       'name' => '1.l. Barang Pribadi dan Jasa Perorangan'],
    ...
    public static $list_group_rilis_komponen = [
        ...
        ['column' => "c_1",     'column_alias' => "1.", 'name' => '1. Konsumsi Akhir Rumah Tangga'],
        ['column' => "c_2",     'column_alias' => "2.", 'name' => '2. Konsumsi Akhir Pemerintah'],
        ['column' => "c_3",     'column_alias' => "3.",  'name' => '3. Pembentukan Modal Tetap Bruto'],
    ...
    public static $list_detail_komponen_rilis = [
        ...
        ['id' => 'c_1',   'select_id' => 'c_1',                     'alias' => '1. PK-RT',    'name' => '1. Konsumsi Akhir Rumah Tangga',   'name_group' => '1. Konsumsi Akhir Rumah Tangga'],
        ['id' => 'c_2',   'select_id' => 'c_3',                     'alias' => '2. PK-P',     'name' => '2. Konsumsi Akhir Pemerintah',     'name_group' => '2. Konsumsi Akhir Pemerintah'],
        ['id' => 'c_3',   'select_id' => 'c_4',                     'alias' => '3. PMTB',     'name' => '3. Pembentukan Modal Tetap Bruto', 'name_group' => '3. Pembentukan Modal Tetap Bruto'],
        ['id' => 'c_4',   'select_id' => 'c_2 + c_5 + c_6 + c_7',   'alias' => '4. Lainnya',  'name' => '4. Lainnya',                       'name_group' => '4. Lainnya'],
        ['id' => 'c_pdrb', 'select_id' => 'c_pdrb',                 'alias' => 'PDRB',        'name' => 'PDRB',                             'name_group' => '5. PDRB'],
    ];


    public static $list_detail_komponen_rekon = [
        ['id' => 'c_1a',  'alias' => '1a. PKRT-Mamin  ',    'name' => '1.a. Makanan dan Minuman Non Beralkohol'],
        ['id' => 'c_1b',  'alias' => '1b. PKRT-MinRok',     'name' => '1.b. Minuman Beralkohol dan Rokok'],
        ['id' => 'c_1c',  'alias' => '1c. PKRT-Pakaian',    'name' => '1.c. Pakaian'],
        ['id' => 'c_1d',  'alias' => '1d. PKRT-Energi ',    'name' => '1.d. Perumahan, Air, Listrik, Gas dan Bahan Bakar Lainnya'],
        ...
        ['id' => 'c_1a+c_1b',  'alias' => '1ab. PKRT-Maminkok',     'name' => '1.ab. Makanan dan Minuman'],
        ...
        ['id' => 'c_4a',  'alias' => '4a. PMTB-Bang',       'name' => '4.a. Bangunan'],
        ['id' => 'c_4b',  'alias' => '4b. PMTB-NB',         'name' => '4.b. Non Bangunan'],
        ['id' => 'c_4a+c_4b',  'alias' => '4. PMTB',         'name' => '4. PMTB'],
        ['id' => 'c_5',   'alias' => '5. PI',               'name' => '5. Perubahan Inventori'],
        ['id' => 'c_6',   'alias' => '6. X LN',             'name' => '6. Ekspor Barang dan Jasa'],
        ['id' => 'c_7',   'alias' => '7. M LN',             'name' => '7. Impor Barang dan Jasa'],
        ['id' => 'c_6-c_7',   'alias' => 'Eksim',             'name' => 'Ekspor Impor'],
        ['id' => 'c_1a+c_1b+c_1c+c_1d+c_1e+c_1f+c_1g+c_1h+c_1i+c_1j+c_1k+c_1l+c_2+c_3+c_4a+c_4b+c_5+c_6-c_7',   'alias' => 'PDRB',             'name' => 'PDRB'],
    ];
}
