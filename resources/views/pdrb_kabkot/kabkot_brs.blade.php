...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">Tabel PDRB per Kabupaten Kota (BRS)</li>
    </ul>
@endsection
...
@section('content')
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2>Tabel PDRB per Kabupaten Kota (BRS)</h2>
                </div>
                <div class="body">
                    <div class="row">
                        <div class="col">
...
@section('scripts')
    <script>
        function updateFormAction(selectElement) {
            ...
            form.action = window.origin + '/superi/public/pdrb_kabkot_brs' + '/' + data_id;
            form.submit();
        }
        ...
        function updateFormActionWilayah() {
            ...
            form.action = window.origin + '/superi/public/pdrb_kabkot_brs' + '/' + data_id + '?wilayah_filter=' + wilayah;
