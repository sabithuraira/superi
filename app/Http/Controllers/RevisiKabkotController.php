...
class RevisiKabkotController extends Controller
{
    ...
    public $list_group_komponen = [
        ['column' => "1, 1.a, 1.b, 1.d, 1.e, 1.f, 1.g", 'name' => '1. Pengeluaran Konsumsi Rumah Tangga'],
    ...
    public function index(Request $request, $id)
    {
        ...
        return view('revisi.kabkot', compact('list_tabel', 'list_periode', 'list_wilayah', 'list_detail_komponen', 'list_group_komponen', 'tabel_filter', 'periode_filter', 'wilayah_filter', 'komponen_filter', 'data'));
    }
