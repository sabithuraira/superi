...
class PdrbPutaranController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        $list_detail_komponen = Komponen::orderby('no_komponen')->get();
        $list_wilayah = $this->list_wilayah;
        $tabel_filter = $request->tabel_filter ? $request->tabel_filter : '3.1';
        ...
        return view('pdrb_putaran.index', compact('list_tabel', 'list_periode', 'list_wilayah', 'tabel_filter', 'periode_filter', 'wilayah_filter', 'putaran_filter', 'data'));
    }
}
