...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">Arah Revisi Provinsi (PKRT 7 Komponen)</li>
    </ul>
@endsection
...
@section('content')
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2>Arah Revisi Provinsi (PKRT 7 Komponen)</h2>
                </div>
                <div class="body">
                    <div class="row">
                        <div class="col">
                            <form id="form_filter" method="get" action="{{ url('revisi_kabkot') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 col-md-2 d-grid ">
                                        <a class="btn btn-primary w-100" type="button"
                                            href="{{ url('revisi_kabkot_rilis/301') }}">Tabel Rilis</a>
                                    </div>
                                </div>
                            </form>
                        </div>
